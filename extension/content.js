...
(function initDeviceEmulation() {
  console.log('🎭 Checking device emulation status...');
  ...
  window.addEventListener('load', () => {
    setTimeout(() => {
      ...
      if (!isMobileVersion) {
        ...
        console.info('💡 Extension should auto-emulate mobile. If you see this, please:');
        console.info('   1. Check extension permissions (debugger, tabs)');
        console.info('   2. Reload this page (extension will auto-emulate)');
        console.info('   3. Or click "📱 Emulate Mobile (Auto)" button in extension popup');
      } else {
        console.log('✅ Mobile version loaded successfully!');
        console.log('🔗 Deep links should be available in page HTML');
      }
    }, 1000);
  });
})();
